...
export const projects: Project[] = [
  {
    ...
    stack: ["Python", "FastAPI", "dbt", "DuckDB", "React 19", "Gemini", "GCP", "Vercel"],
  ...
  },
  {
    ...
    metrics: [
      ...
      "Cited-evidence RAG: FAISS + pgvector HNSW with PASS / REVIEW / BLOCKED eval gates",
      "HMAC-SHA-256 signed audit event stream and Evidence Pack JSON export",
      "Spring Boot 3 backend: Flyway V1–V6, multi-tenant JPA isolation, eval worker queue",
      "Next.js 14 dashboard with interactive DAG lineage graph",
    ],
    stack: ["Java 17", "Spring Boot 3", "PostgreSQL", "pgvector", "Next.js 14", "FAISS"],
    period: "2024 – Present",
  ...
  },
  {
    ...
    stack: ["Python", "FastAPI", "DuckDB", "React", "FAISS", "Gemini 2.5 Flash"],
  ...
  },
  {
    name: "EmployerFlow",
    tagline:
      "Visa-aware employer discovery SaaS — deterministic scoring, template-based outreach, Stripe subscriptions. No LLM at any stage.",
    metrics: [
      "15,000+ employer directory with visa filters",
      "Deterministic shortlist scoring (Pro / Premium tiers)",
      "CRM with application pack generation",
      "$0/month production stack (Render + Neon)",
    ],
    stack: ["FastAPI", "PostgreSQL", "Stripe", "Vanilla JS", "Docker"],
    period: "2025 – Present",
  ...
  },
  {
    ...
    metrics: [
      ...
      "React Native 0.83 staff app with offline queue (1,000 actions / 30s sync)",
  ...
  },
  {
    ...
    stack: ["Python", "FastAPI", "FAISS", "React 18", "Supabase", "pgvector", "Gemini"],
