...
export const experience = {
  ...
  sector: "Fintech — algorithmic trading and AI-powered equity research for cash and derivatives markets",
  period: "Sep 2025 – Present",
  highlights: [
    "Own end-to-end delivery of an institutional equity research terminal covering 10 market sectors: Gemini 2.5 Flash with 10 Tier-1 filters and a 100-point Tier-2 scoring model, SSE streaming, Supabase Auth, and PostgreSQL conversation history.",
    "Built production hybrid RAG over 305 annual reports for 52 large-cap index constituents (FY2020–FY2025): FAISS IndexFlatIP, BM25, reciprocal rank fusion, and cross-encoder reranking into a ~143K-chunk pipeline with sector-aware retrieval and inline citations.",
